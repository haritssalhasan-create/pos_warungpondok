...
<head>
    ...
    <title>Edit Transaksi - toko</title>
        ...
        <div class="flex-1 overflow-y-auto p-6"
            ...
            <div class="w-full max-w-2xl mx-auto space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-slate-100">Edit <span style="color:#6ee7b7;">Transaksi</span></h1>
                        <p class="text-xs text-slate-500">toko · Perbarui informasi transaksi</p>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="transaksi_action.php?aksi=update" method="post">
                    ...
                    <div class="form-card p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <select name="id_user" class="field-select">
                                ...
                                ?>
                                    <option value="<?= $u['id'] ?>" <?= $selected ?>><?= htmlspecialchars($u['nama']) ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="input-prefix-wrap">
                                ...
                                <input class="field-input" placeholder="cth. 150000" type="number" name="total_pembelian" value="<?= $data['total_pembelian'] ?>" />
                            </div>
                        </div>

                        <div>
                            <label class="field-label">Tanggal Transaksi</label>
                            <input class="field-input" type="date" name="tgl_transaksi" value="<?= $data['tgl_transaksi'] ?>" />
                        </div>
