...
<head>
    ...
    <title>Edit Detail Transaksi - Warung Averroes</title>
...
<body class="flex min-h-screen">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <?php
        $page_name = "Edit Detail Transaksi";
        ...
        <div class="flex-1 overflow-y-auto p-6"
            ...
            <div class="w-full max-w-2xl mx-auto space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-slate-100">Edit <span style="color:#34d399;">Detail Transaksi</span></h1>
                        <p class="text-xs text-slate-500">Perbarui item dalam transaksi ini</p>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="detail_transaksi_action.php?aksi=update" method="post">
                    ...
                    <div class="form-card p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <select name="id_transaksi" class="field-select">
                                ...
                                ?>
                                    <option value="<?= $t['id'] ?>" <?= $selected ?>>Transaksi #<?= $t['id'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:16px;">
                            <div>
                                ...
                                <input class="field-input" placeholder="cth. 2" type="number" name="jumlah" value="<?= $data['jumlah'] ?>" />
                            </div>
                            <div>
                                <label class="field-label">Total Jumlah</label>
                                <input class="field-input" placeholder="cth. 300000" type="number" name="total_jumlah" value="<?= $data['total_jumlah'] ?>" />
                            </div>
                        </div>
