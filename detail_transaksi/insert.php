...
<head>
    ...
    <title>Tambah Detail Transaksi - Warung Averroes</title>
...
<body class="flex min-h-screen">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <?php
        $page_name = "Tambah Detail Transaksi";
        ...
        <div class="flex-1 overflow-y-auto p-6"
            ...
            <div class="w-full max-w-2xl mx-auto space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-slate-100">Tambah <span style="color:#34d399;">Detail Transaksi</span></h1>
                        <p class="text-xs text-slate-500">Tambahkan item baru ke transaksi</p>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="detail_transaksi_action.php?aksi=insert" method="post">
                    <div class="form-card p-6 space-y-5">

                        <div>
                            <label class="field-label">ID Transaksi</label>
                            <select name="id_transaksi" class="field-select">
                                <?php
                                $transaksis = showDataTransaksi($con);
                                while ($t = $transaksis->fetch_assoc()):
                                ?>
                                    <option value="<?= $t['id'] ?>">Transaksi #<?= $t['id'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="id_product" class="field-select">
                                <?php
                                $products = showDataProduct($con);
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:16px;">
                            <div>
                                ...
                                <input class="field-input" placeholder="cth. 2" type="number" name="jumlah" />
                            </div>
                            <div>
                                <label class="field-label">Total Jumlah</label>
                                <input class="field-input" placeholder="cth. 300000" type="number" name="total_jumlah" />
                            </div>
                        </div>

                        <div class="info-box">
                            <i class="ti ti-info-circle" style="font-size:18px; color:#34d399; flex-shrink:0; margin-top:2px;"></i>
                            <p style="font-size:12px; color:#94a3b8; line-height:1.5;">
                                Pastikan jumlah dan total sesuai dengan harga produk × kuantitas yang dipilih.
                            </p>
                        </div>
