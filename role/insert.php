...
<head>
    ...
    <title>Tambah Role - Warung Averroes</title>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; box-sizing: border-box; }
        ...
        .field-label {
            ...
            text-transform: uppercase; color: #c4b5fd; margin-bottom: 8px; display: block;
        }
        ...
        .btn-save:hover { transform: translateY(-1px); box-shadow: 0 6px 24px rgba(124,58,237,0.55); }
        ...
        .divider { height: 1px; background: linear-gradient(to right, transparent, rgba(167,139,250,0.3), transparent); margin: 4px 0; }
        ...
        <div class="flex-1 overflow-y-auto p-6"
            ...
            <div class="w-full max-w-2xl mx-auto space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-slate-100">Tambah <span style="color:#c4b5fd;">Role</span></h1>
                        <p class="text-xs text-slate-500">Buat role baru untuk hak akses pengguna</p>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="role_action.php?aksi=insert" method="post">
                    <div class="form-card p-6 space-y-5">

                        <div>
                            <label class="field-label">Nama Role</label>
                            <input class="field-input" placeholder="cth. Kasir" type="text" name="nama_role" autofocus />
                        </div>

                        <div class="info-box">
                            <i class="ti ti-info-circle" style="font-size:18px; color:#c4b5fd; flex-shrink:0; margin-top:2px;"></i>
                            <p style="font-size:12px; color:#94a3b8; line-height:1.5;">
                                Role digunakan untuk menentukan hak akses tiap pengguna di sistem, contoh: Admin, Kasir, Manager.
                            </p>
                        </div>
