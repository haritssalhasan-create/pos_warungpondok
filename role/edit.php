        ...
        <div class="flex-1 overflow-y-auto p-6"
            ...
            <div class="w-full max-w-2xl mx-auto space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-slate-100">Edit <span style="color:#c4b5fd;">Role</span></h1>
                        <p class="text-xs text-slate-500">Perbarui nama role pengguna</p>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="role_action.php?aksi=update" method="post">
                    <input type="hidden" name="id" value="<?= $data['id'] ?>">

                    <div class="form-card p-6 space-y-5">
                        <div>
                            <label class="field-label">Nama Role</label>
                            <input class="field-input" placeholder="cth. Admin" type="text" name="nama_role" value="<?= htmlspecialchars($data['nama']) ?>" />
                        </div>
