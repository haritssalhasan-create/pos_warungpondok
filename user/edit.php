...
<head>
    ...
    <title>Edit User - Warung Averroes</title>
        ...
        <div class="flex-1 overflow-y-auto p-6"
            ...
            <div class="w-full max-w-2xl mx-auto space-y-5 pb-10">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-slate-100">Edit <span style="color:#34d399;">User</span></h1>
                        <p class="text-xs text-slate-500">Perbarui informasi akun pengguna</p>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="user_action.php?aksi=update" method="post">
                    ...
                    <div class="form-card p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <div class="field-icon-wrap">
                                ...
                                <input class="field-input" placeholder="cth. John Doe" type="text" name="nama" value="<?= htmlspecialchars($data['nama']) ?>" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-icon-wrap">
                                ...
                                <input class="field-input" placeholder="cth. Jl. Raya..." type="text" name="alamat" value="<?= htmlspecialchars($data['alamat']) ?>" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-icon-wrap">
                                ...
                                <input class="field-input" placeholder="cth. 08123456789" type="text" name="no_hp" value="<?= htmlspecialchars($data['no_hp']) ?>" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-icon-wrap">
                                ...
                                <input class="field-input" placeholder="cth. johndoe" type="text" name="username" value="<?= htmlspecialchars($data['username']) ?>" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-icon-wrap">
                                ...
                                <input class="field-input" id="password" placeholder="••••••••" type="password" name="password" value="<?= htmlspecialchars($data['password']) ?>" style="padding-right:42px;" />
                        ...
                        <div>
                            ...
                            <select name="id_role" class="field-select">
                                ...
                                ?>
                                    <option value="<?= $r['id'] ?>" <?= $selected ?>><?= htmlspecialchars($r['nama']) ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
