...
<head>
    ...
    <title>Edit Kategori - Warung Averroes</title>
            ...
            <div class="w-full max-w-2xl mx-auto space-y-5">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center"
                        ...
                        <i class="ti ti-pencil" style="font-size:18px; color:#fff;"></i>
                    </div>
                    <div>
                        <h1 class="text-xl font-bold text-slate-100">Edit <span style="color:#fbbf24;">Kategori</span></h1>
                        <p class="text-xs text-slate-500">Perbarui informasi kategori produk</p>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="category_action.php?aksi=update" method="post">
                    <input type="hidden" name="id" value="<?= $data['id'] ?>">

                    <div class="form-card p-6 space-y-5">
                        <div>
                            <label class="field-label" for="nama_category">Nama Kategori</label>
                            <input class="field-input" id="nama_category" placeholder="cth. Minuman" type="text"
                                   name="nama_category" value="<?= htmlspecialchars($data['nama']) ?>" />
                        </div>
